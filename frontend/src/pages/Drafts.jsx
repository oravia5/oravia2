...
export default function Drafts() {
  ...
  const fetchDrafts = async () => {
    ...
    setLoading(true);
    try {
      const res = await client.get(`/posts?author=${user._id}&draft=true`);
      if (res.data.success) {
  ...
  return (
    <div className="settings-subpage">
      <header className="subpage-header">
        ...
        <span className="subpage-header-title">Drafts</span>
      ...
      <main className="subpage-body">
        {loading ? (
          ...
          <div className="subpage-empty-state">
            ...
            <p>Unsaved posts you write will appear here.</p>
          </div>
        ) : (
          <div className="posts-preview-grid">
            {drafts.map((post) => (
              <div 
                ...
                onClick={() => navigate('/create-post', { state: { editDraft: post } })}
              >
                ...
                <div className="preview-info">
                  <p className="preview-caption">{post.caption || 'Untitled Draft'}</p>
